...
//  Hard Disk type:
//  - Create a new blank disk image with 65535 sectors and double density. This will create a 16 megabyte Atari hard disk image.
//  * Only MyDOS and SpartaDOS will support a large hard disk?
